...
Mulai output langsung dengan '🔮 DUKUN CRYPTO 🔮' tanpa penjelasan atau disclaimer. Semua analisis adalah untuk tujuan pendidikan dan pemahaman pola grafik saja."""
                                },
                                {
                                    "role": "user",
                                    "content": [
...
Mulai output langsung dengan '🔮 DUKUN CRYPTO 🔮' tanpa penjelasan atau disclaimer. Semua analisis adalah untuk tujuan pendidikan dan pemahaman pola grafik saja."""
            ...
            if "unable to provide" in analysis.lower() or "i can guide you" in analysis.lower() or "i can't assist" in analysis.lower() or "i'm sorry" in analysis.lower() or "sorry" in analysis.lower():
                match = re.search(r'🔮 DUKUN CRYPTO 🔮', analysis)
                if match:
                    start_idx = match.start()
                    analysis = analysis[start_idx:]
                else:
                    # Jika tidak menemukan header DUKUN CRYPTO, buat respons fallback sederhana
                    analysis = """🔮 DUKUN CRYPTO 🔮
